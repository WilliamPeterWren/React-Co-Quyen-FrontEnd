        ...
        <div className="container">
          ...
          <nav className="navbar navbar-main navbar-expand pl-0">
            <ul className="navbar-nav flex-wrap">
              ...
              <li className="nav-item">
                <a className="nav-link" href="/">Đèn xe</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/">Phuộc</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/">Nón bảo hiểm</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/">Mâm</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/">Ốc tán</a>
              </li>
              <li className="nav-item">
